...
pub enum EffectType {
    ...
    MonsterLabelBuff = 126,                 // Monster label buff
    ...
    RealHurtSkillEffectFix = 122,

    RealHarmSkillEffectFix = 123,
...
impl EffectType {
    pub fn from_i32(value: i32) -> Self {
        match value {
            ...
            120 => Self::RealHurtFix,
            121 => Self::RealHarmFix,
            122 => Self::RealHurtSkillEffectFix,
            123 => Self::RealHarmSkillEffectFix,
            126 => Self::MonsterLabelBuff,
