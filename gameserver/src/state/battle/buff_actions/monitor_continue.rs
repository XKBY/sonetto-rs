//! buff_act 1024 MonitorContinueChannel — Sentinel Dread Bullet trigger
//! chain (post-enemy-action Expiation firing).
...
/// Returns `(prerequisite_buff_id, monitor_buff_id, emit_effect_id, emit_skill_id)`
/// or `None` if the buff isn't carrying this feature or the emit ids are 0.
pub fn buff_get_monitor_continue_channel_params(buff_id: i32) -> Option<(i32, i32, i32, i32)> {
    let parts = super::find_feature_parts(buff_id, "MonitorContinueChannel")?;
